        ...
        <div className="lg:col-span-2 border border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-white dark:bg-gray-800">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-md p-3 text-xs text-gray-500 dark:text-gray-400">
              <p className="font-medium text-gray-700 dark:text-gray-300 mb-1">最佳实践</p>
            ...
            <div className="flex gap-3">
              ...
              {!isNew && configs.length > 1 && (
                <button onClick={handleDelete}
                  className="px-4 py-2 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 rounded-md text-sm font-medium hover:bg-red-50 dark:hover:bg-red-900/20 ml-auto">
                  删除
                </button>
              )}
            </div>
